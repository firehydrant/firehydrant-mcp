...
Install the MCP server as a Desktop Extension using the pre-built [`mcp-server.mcpb`](https://github.com/firehydrant/firehydrant-mcp/releases/download/v0.0.4/mcp-server.mcpb) file:

Simply drag and drop the [`mcp-server.mcpb`](https://github.com/firehydrant/firehydrant-mcp/releases/download/v0.0.4/mcp-server.mcpb) file onto Claude Desktop to install the extension.
