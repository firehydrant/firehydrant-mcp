...
export function landingPageHTML(origin: string): string {
  ...
  const codexConfig = `[mcp_servers.FireHydrant]
url = "${o}/sse"
http_headers = { "api-key" = "YOUR_API_KEY" }`;
...
<head>
    ...
    <title>firehydrant-mcp MCP</title>
    <meta name="description" content="Install firehydrant-mcp MCP server.">
    <meta property="og:type" content="website">
    <meta property="og:title" content="firehydrant-mcp - MCP Server">
    <meta property="og:description" content="Install firehydrant-mcp MCP server.">
    <meta property="twitter:card" content="summary">
    <meta property="twitter:title" content="firehydrant-mcp - MCP Server">
    <meta property="twitter:description" content="Install firehydrant-mcp MCP server.">
      ...
      <div class="content-container">
          ...
          <div class="header container">
            <div class="mcp-meta">
              ...
              <div class="header-content">
                <div class="mcp-name">firehydrant-mcp</div>
            ...
            <div class="header-actions">
              ...
              <div class="popover">
                ...
                <div class="popover-menu hidden" id="popover-menu">
                  <a class="popover-button install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=FireHydrant&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJmaXJlaHlkcmFudC1tY3AiLCJzdGFydCIsIi0tYXBpLWtleSIsIiJdfQ==">
                    Cursor
                  </a>
                  ...
                  <a class="popover-button install-link" href="vscode://ms-vscode.vscode-mcp/install?name=FireHydrant&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJmaXJlaHlkcmFudC1tY3AiLCJzdGFydCIsIi0tYXBpLWtleSIsIiJdfQ==">
                    VS Code
                  </a>
        ...
        <section class="install container">
          ...
          <div class="install-targets">
            <a tabindex="0" class="card install-target install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=FireHydrant&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJmaXJlaHlkcmFudC1tY3AiLCJzdGFydCIsIi0tYXBpLWtleSIsIiJdfQ==">
              <div class="target">
            ...
            <a tabindex="0" class="card install-target install-link" href="vscode://ms-vscode.vscode-mcp/install?name=FireHydrant&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJmaXJlaHlkcmFudC1tY3AiLCJzdGFydCIsIi0tYXBpLWtleSIsIiJdfQ==">
              <div class="target">
    ...
    <div class="modal" id="claude-code-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="claude-cli-cmd">claude mcp add FireHydrant -- npx -y firehydrant-mcp start --api-key </code>
        </div>
      </div>
    </div>
    ...
    <div class="modal" id="claude-desktop-modal">
      ...
      <div class="content-slot">
        ...
        <div class="instruction-item">
          <a href="https://github.com/firehydrant/firehydrant-mcp/releases/download/v0.1.0/mcp-server.mcpb" download="mcp-server.mcpb" class="action-button header-action" style="display: inline-flex; margin-bottom: 16px;">
            📥 Download MCP Bundle
          </a>
        </div>
    ...
    <div class="modal" id="gemini-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="gemini-config">gemini mcp add FireHydrant -- npx -y firehydrant-mcp start --api-key </code>
        </div>
      </div>
    </div>
