...
import {
  ...
  GetTeamOnCallScheduleRequest$zodSchema,
  GetTeamOnCallScheduleResponse,
  GetTeamOnCallScheduleResponse$zodSchema,
} from "../models/getteamoncallscheduleop.js";
...
export function signalsGetTeamOnCallSchedule(
  ...
  request: GetTeamOnCallScheduleRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetTeamOnCallScheduleRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, GetTeamOnCallScheduleResponse$zodSchema, {
      key: "Signals_API_OnCallScheduleEntity",
    }),
